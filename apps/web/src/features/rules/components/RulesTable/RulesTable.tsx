...
/**
 * Уставки по режимам. Проверяются они той же схемой, что и на сервере: расходиться правилам
 * нельзя, иначе экран разрешает то, что шлюз отвергнет. Правка уезжает одним запросом со всеми
 * тронутыми строками, и вместе с ней в базе появляется запись журнала.
 */
