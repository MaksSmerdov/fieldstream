...
/**
 * Насколько крупно сдвигается правый край окна. Посекундный сдвиг менял бы ключ запроса на
 * каждом кадре, и окно перезапрашивалось бы чаще, чем появляются данные.
 */
