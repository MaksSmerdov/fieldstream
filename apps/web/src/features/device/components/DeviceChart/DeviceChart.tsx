...
/**
 * График прибора. Источник данных выбирает сервер и присылает вместе с точками, так что подпись
 * под графиком не расходится с содержимым. Полоса режимов рисуется на той же канве.
 */
export const DeviceChart = ({ code, params }: Props): React.JSX.Element => {
  ...
  /**
   * Описание графика словами: канва для вспомогательных программ пуста. Нужны сами кривые,
   * их пределы и число оттаек за окно.
   */
