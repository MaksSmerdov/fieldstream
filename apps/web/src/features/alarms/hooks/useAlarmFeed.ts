...
/**
 * Лента алармов. Страницы берутся курсором: при смещении новый эпизод во главе ленты сдвигал бы
 * всё вниз, и вторая страница повторяла бы конец первой. Живые события правят этот же кэш,
 * поэтому лента пополняется без повторных запросов.
 */
