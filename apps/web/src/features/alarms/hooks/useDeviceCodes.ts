...
/**
 * Коды приборов для фильтра. Берутся из того же дерева объектов, что и обзор: список
 * приборов в ленте не должен собираться из самих алармов, иначе прибор без единого эпизода
 * в фильтре не найти.
 */
