...
/**
 * Подтверждение аларма. Отметка ставится сразу, до ответа сервера: на ленте из сотни строк
 * ожидание ответа читается как «кнопка не сработала», и человек жмёт второй раз. Если сервер
 * откажет, отметка снимается и ошибка показывается словами.
 */
