...
/**
 * Восстановление сессии при загрузке вкладки. Токен доступа живёт в памяти, но cookie обновления
 * осталась: одна попытка прокрутить пару решает, показывать приложение или форму входа.
 */
