...
/**
 * Кто вошёл и как выйти. Имя роли рядом с почтой не украшение: половина кнопок на экранах
 * зависит от прав, и человек должен видеть, какими он сейчас работает. Выход чистит куку
 * обновления на сервере, поэтому кнопка нужна отдельно от закрытия вкладки.
 */
