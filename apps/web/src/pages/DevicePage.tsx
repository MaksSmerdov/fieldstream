...
/**
 * Экран прибора: шапка и график всегда сверху, остальное по вкладкам. Уставки и карта регистров
 * запрашиваются при открытии своей вкладки, а не при каждом заходе на прибор.
 */
