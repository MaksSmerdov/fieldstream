...
export const AlarmsPage = (): React.JSX.Element => {
  ...
  /**
   * Новый эпизод приезжает живым каналом, и лента объявляет его вслух. Объявление привязано
   * к фильтру: иначе первая строка нового набора читалась бы как только что случившийся аларм.
   */
