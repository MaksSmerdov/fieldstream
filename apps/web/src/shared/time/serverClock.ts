/**
 * Единая шкала времени, единственное место во фронте, где читаются системные часы. При
 * расхождении часов браузера и сервера свежие данные выглядят протухшими, а протухшие свежими.
 */
let offsetMs = 0;
let known = false;
