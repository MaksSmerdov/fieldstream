...
/**
 * Полосы режимов. Рисуются прямо на канве после очистки и до кривых: отдельная полоска под
 * графиком неминуемо разъехалась бы с ним по горизонтали, потому что ширину оси значений
 * uPlot считает сам и заранее она неизвестна.
 */
...
/**
 * Обёртка uPlot. Держит один экземпляр графика на всё время жизни набора кривых: пересоздание
 * на каждое обновление данных стоило бы дороже самой отрисовки, а на живом экране данные
 * приходят постоянно.
 */
