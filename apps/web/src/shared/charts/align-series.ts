...
/**
 * Общая шкала для нескольких метрик. У метрики может не быть точки в бакете, где у соседней
 * она есть: без общей шкалы кривые разъезжались бы по горизонтали, а пропуск обязан остаться
 * пропуском, иначе график соединит прямой линией часы, где данных не было вовсе.
 */
