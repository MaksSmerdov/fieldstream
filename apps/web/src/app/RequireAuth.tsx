...
/**
 * Защита маршрутов. Пока вкладка не проверила cookie обновления, решения нет: отправлять
 * на вход в этот момент значит выбрасывать человека при каждой перезагрузке страницы.
 */
