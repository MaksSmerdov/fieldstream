 ...
 * второй писатель ломает порядок и размывает ответственность, поэтому это ошибка, а не предупреждение.
 * Схема проверяется на публикации, чтобы битые данные падали у автора, а не у всех потребителей.
 */
