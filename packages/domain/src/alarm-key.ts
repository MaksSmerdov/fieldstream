...
/**
 * Идентификатор аларма считается из ключа эпизода, а не выдаётся базой: одна и та же история,
 * прогнанная заново, даёт те же идентификаторы, и записи реплея сравнимы с боевыми.
 */
