...
/**
 * Кольцо последних событий. У клиента после обрыва два исхода: получить пропущенное или узнать,
 * что пропустил слишком много. Третьего у `since` нет, молча терять события нельзя.
 */
