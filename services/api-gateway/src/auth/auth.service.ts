...
export class AuthService {
  ...
  /**
   * Обновление пары. Ротация атомарна, из двух одновременных запросов строку получает один,
   * проигравший берёт ту же пару из окна повтора. Старый токен вне окна считается утечкой.
   */
