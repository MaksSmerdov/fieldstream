...
export class DevicesController {
  ...
  /** Серия за окно. Источник и шаг выбирает та же функция, что и фронт, и они едут вместе с данными. */
  @Get(':code/series')
  @RequirePermission('devices')
  public async series(
  ...
  /** Происшествия прибора за окно и полоса режимов по ним. Режим на начало окна знает только база. */
  @Get(':code/events')
  @RequirePermission('devices')
  public async events(
    @Param('code') code: string,
  ...
  /** Журнал правок уставок. Читать его может всякий, кто видит прибор. */
